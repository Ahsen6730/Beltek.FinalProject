...
namespace Beltek.AhsenAslan.FinalProject.UI.Controllers
{
    public class PriceController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Quantity,ProductId,UpdateDate")] Price price)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Quantity,ProductId,UpdateDate")] Price price)
        {
            if (id != price.Id)
            {
                return NotFound();
